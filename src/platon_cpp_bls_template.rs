pub const  PLATON_CPP_BLS_CONTRACT_TEMPLATE : &str = r#"#include "platon/crypto/bls12381/bls12381.hpp"
...
struct KeyedVerifier : public Plonk4VerifierWithAccessToDNext {
  ...
  VerificationKey get_verification_key() {
    VerificationKey vk = {
        ...
        "{{omega}}"_uint256,
        {
            G1{ "{{selector_commitment_0_0}}"_uint384,
                "{{selector_commitment_0_1}}"_uint384 },
            G1{ "{{selector_commitment_1_0}}"_uint384,
                "{{selector_commitment_1_1}}"_uint384 },
            G1{ "{{selector_commitment_2_0}}"_uint384,
                "{{selector_commitment_2_1}}"_uint384 },
            G1{ "{{selector_commitment_3_0}}"_uint384,
                "{{selector_commitment_3_1}}"_uint384 },
            G1{ "{{selector_commitment_4_0}}"_uint384,
                "{{selector_commitment_4_1}}"_uint384 },
            G1{ "{{selector_commitment_5_0}}"_uint384,
                "{{selector_commitment_5_1}}"_uint384 }
        },
        {
            G1{
                "{{next_step_selector_commitment_0_0}}"_uint384,
                "{{next_step_selector_commitment_0_1}}"_uint384 }
        },
        {
            G1{ "{{permutation_commitment_0_0}}"_uint384,
                "{{permutation_commitment_0_1}}"_uint384 },
            G1{ "{{permutation_commitment_1_0}}"_uint384,
                "{{permutation_commitment_1_1}}"_uint384 },
            G1{ "{{permutation_commitment_2_0}}"_uint384,
                "{{permutation_commitment_2_1}}"_uint384 },
            G1{ "{{permutation_commitment_3_0}}"_uint384,
                "{{permutation_commitment_3_1}}"_uint384 }
        },
        {
        ...
        G2{ "{{g2_x_x_c1}}"_uint384, "{{g2_x_x_c0}}"_uint384, "{{g2_x_y_c1}}"_uint384, "{{g2_x_y_c0}}"_uint384 }
    };
